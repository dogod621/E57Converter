...
namespace e57
{
	...
	public:
		...
		void ExportToPCD(const double voxelUnit, const unsigned int searchRadiusNumVoxels, const int meanK, const int polynomialOrder, bool reconstructAlbedo, bool reconstructNDF, pcl::PointCloud<PointPCD>& out);
		void ReconstructNDF(const double voxelUnit, const unsigned int searchRadiusNumVoxels, pcl::PointCloud<PointPCD>& cloud);
	};
}